...
public class AdditionRecipeValueTypeWorldRenderer implements IValueTypeWorldRenderer {

    private static final IValueTypeWorldRenderer INGREDIENTS_RENDERER = HugeDisplayPartOverlayRenderer.RENDERS.get(ValueTypes.OBJECT_INGREDIENTS);
    ...
    public void renderValue(TileEntityRendererDispatcher rendererDispatcher, IPartContainer partContainer,
        ...
        if (recipeOptional.isPresent()) {
            ...
            matrixStack.push();
            matrixStack.scale(0.3F * 6.5F, 0.3F * 6.5F, 1F);
            rendererDispatcher.getFontRenderer().renderString(L10NHelpers.localize("gui.integrateddynamics.input_short"), 6 - 16 - 12.5F, 15 - 16 - 16, Helpers.RGBToInt(255, 255, 255),
                    false, matrixStack.getLast().getMatrix(), renderTypeBuffer, false, 0, combinedLight);
            rendererDispatcher.getFontRenderer().renderString(L10NHelpers.localize("gui.integrateddynamics.output_short"), 10, 15 - 16 - 16, Helpers.RGBToInt(255, 255, 255),
                    false, matrixStack.getLast().getMatrix(), renderTypeBuffer, false, 0, combinedLight);
            matrixStack.pop();

            matrixStack.translate(-12.5F - 12.5F, 2 * HugeDisplayPartOverlayRenderer.MAX / 3 - 12.5F - 16, 0);
            ...
            matrixStack.translate(HugeDisplayPartOverlayRenderer.MAX + 16 * 3 + 12.5F-2.5F, +16 + 12.5F + 16 + 16, 0);
    ...
    protected void renderInput(TileEntityRendererDispatcher rendererDispatcher, IPartContainer partContainer,
        ...
        for (IngredientComponent<?, ?> component : recipe.getInputComponents()) {
            ...
            inputs.forEach(element ->
                    values.add(componentHandler.toValue(AdditionIngredientsValueTypeWorldRenderer.prepareElementForTick(
        ...
        AdditionIngredientsValueTypeWorldRenderer.renderGrid(rendererDispatcher, partContainer, direction, partType, values,

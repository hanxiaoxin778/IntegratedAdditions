...
public class AdditionNbtValueTypeWorldRenderer  implements IValueTypeWorldRenderer {
    ...
    public void renderValue(TileEntityRendererDispatcher rendererDispatcher, IPartContainer partContainer,
        ...
        float scaleX = HugeDisplayPartOverlayRenderer.MAX / (maxWidth.get() * MARGIN_FACTOR);
        float scaleY = HugeDisplayPartOverlayRenderer.MAX / (totalHeight * MARGIN_FACTOR);

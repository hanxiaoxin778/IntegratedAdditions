...
public class AdditionTextValueTypeWorldRenderer implements IValueTypeWorldRenderer {
    ...
    public void renderValue(TileEntityRendererDispatcher rendererDispatcher, IPartContainer partContainer,
        ...
        float scaleX = HugeDisplayPartOverlayRenderer.MAX / (maxWidth * MARGIN_FACTOR);
